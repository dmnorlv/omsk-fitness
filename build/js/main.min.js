...
/* harmony import */ var _modules_gym_video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/gym-video */ "./js/modules/gym-video.js");
/* harmony import */ var _modules_products_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/products-tabs */ "./js/modules/products-tabs.js");
/* harmony import */ var _modules_personal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/personal */ "./js/modules/personal.js");
/* harmony import */ var _modules_reviews__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/reviews */ "./js/modules/reviews.js");
/* harmony import */ var _modules_feedback__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/feedback */ "./js/modules/feedback.js");
/* harmony import */ var _modules_lazy_backgrounds__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/lazy-backgrounds */ "./js/modules/lazy-backgrounds.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_navigation__WEBPACK_IMPORTED_MODULE_1__["initNav"])();
  Object(_modules_gym_video__WEBPACK_IMPORTED_MODULE_2__["initVideo"])();
  Object(_modules_lazy_backgrounds__WEBPACK_IMPORTED_MODULE_7__["initLazyImg"])();
  // ---------------------------------

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    Object(_modules_products_tabs__WEBPACK_IMPORTED_MODULE_3__["initTabs"])();
    Object(_modules_personal__WEBPACK_IMPORTED_MODULE_4__["initTranersSlider"])();
    Object(_modules_reviews__WEBPACK_IMPORTED_MODULE_5__["initReviewsSlider"])();
    Object(_modules_feedback__WEBPACK_IMPORTED_MODULE_6__["initPhoneInput"])();
  });
});
...
var onPhoneKeyDown = function onPhoneKeyDown(evt) {
  var inputValue = evt.target.value.replace(/\D/g, '');
  if (evt.keyCode === 8 && inputValue.length === 1) {
    evt.target.value = '';
  }
};
var initPhoneInput = function initPhoneInput() {
  if (phoneInput) {
...
var video = document.querySelector('.gym__video-container');
var background = document.querySelector('.gym__video-background');
var button = document.querySelector('.gym__video-button');
var initVideo = function initVideo() {
  var link = document.querySelector('.gym__link');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initLazyImg", function() { return initLazyImg; });
var initLazyImg = function initLazyImg() {
  var lazyBackgrounds = [].slice.call(document.querySelectorAll('.personal__swiper-slide'));
...
var imageContainer = document.querySelector('.page-header__content-img-container');
var navigation = document.querySelector('.page-header__nav');
var linksWrapper = document.querySelector('.page-header__links-wrapper');
...
/*!********************************!*\
  !*** ./js/modules/personal.js ***!
  \********************************/
/*! exports provided: initTranersSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTranersSlider", function() { return initTranersSlider; });
...
var buttonPrev = document.querySelector('.personal__button-prev');
var buttonNext = document.querySelector('.personal__button-next');
var initTranersSlider = function initTranersSlider() {
  if (buttonPrev && buttonNext) {
    var slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.personal__swiper', {
    ...
    buttonPrev.addEventListener('keydown', function (evt) {
      if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isSpaceKey"])(evt)) {
        slider.slidePrev();
        buttonPrev.classList.add('slider-btn-active');
      }
    });
    buttonPrev.addEventListener('keyup', function (evt) {
      if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isSpaceKey"])(evt)) {
        buttonPrev.classList.remove('slider-btn-active');
      }
    });
    buttonNext.addEventListener('keydown', function (evt) {
      if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isSpaceKey"])(evt)) {
        slider.slideNext();
        buttonNext.classList.add('slider-btn-active');
      }
    });
    buttonNext.addEventListener('keyup', function (evt) {
      if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isSpaceKey"])(evt)) {
...
var productsContainer = document.querySelector('.products__wrapper');
var tabsList = document.querySelector('.products__tabs');
var tabs = document.querySelectorAll('.products__tab-btn');
var subscriptionProducts = document.querySelectorAll('.products__list');
var monthList = 'products__list--month-1';
var halfYearList = 'products__list--month-6';
var yearList = 'products__list--month-12';
var isSpaceKey = function isSpaceKey(evt) {
  return evt.key === ' ';
};
var isNotCurrentTab = function isNotCurrentTab(elem) {
  return !elem.classList.contains('products__tab-btn-js-current');
};
var setCurrentTab = function setCurrentTab(elem) {
...
var setCurrentList = function setCurrentList(string) {
  subscriptionProducts.forEach(function (list) {
...
var initTabs = function initTabs() {
  if (productsContainer && tabs && tabs && subscriptionProducts) {
    ...
    tabs.forEach(function (button) {
      return button.addEventListener('keydown', onTabKeydown);
    });
    tabs.forEach(function (button) {
      return button.addEventListener('keyup', onTabKeyup);
    });
    tabs.forEach(function (button) {
      return button.addEventListener('click', changeContent);
    });
  }
};
...
/*!*******************************!*\
  !*** ./js/modules/reviews.js ***!
  \*******************************/
/*! exports provided: initReviewsSlider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var initReviewsSlider = function initReviewsSlider() {
  if (buttonPrev && buttonNext) {
    var slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__swiper', {
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
      slidesPerView: 1,
      navigation: {
...
/*!***************************!*\
  !*** ./js/utils/utils.js ***!
  \***************************/
/*! exports provided: isSpaceKey */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isSpaceKey", function() { return isSpaceKey; });
var isSpaceKey = function isSpaceKey(evt) {
  return evt.key === ' ';
};
